describe("checking for truth", () => {
  test("are the littleNumbers < bigNumbers?", () => {
    ...
    let littleNumbers: Array<number> = [10, 20, 30, 40, 50];
    let bigNumbers: Array<number> = [300, 420, 660, 870, 990];
  ...
  test("there is a sequence to this test", () => {
    let values: Array<any> = ["Hello", false, 80, null]; // set values here - the array will take any type or combo of types.
